    ...
    "cells": [
        ...
        # ── 2. Clone + deps ──
        {
            ...
            "source": [
                ...
                "# SAM-2 (Facebook's Segment Anything) - install direct from git to handle build isolation\n",
                "!pip install -q git+https://github.com/facebookresearch/sam2.git@0e78a118995e66bb27d78518c4bd9a3e95b4e266 --no-build-isolation\n",
