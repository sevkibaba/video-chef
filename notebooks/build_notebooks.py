    ...
    "cells": [
        ...
        # ── 2. Clone + deps ──
        {
            ...
            "source": [
                ...
                "!pip install -q -e .\n",
                "!pip install -q -r requirements.txt\n",
                "# Install animation specific deps (including onnxruntime-gpu for face/pose)\n",
                "!pip install -q ninja decord loguru onnxruntime-gpu peft pandas matplotlib sentencepiece\n",
