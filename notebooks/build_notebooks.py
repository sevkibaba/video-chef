    ...
    "cells": [
        ...
        # ── 2. Clone + deps ──
        {
            ...
            "source": [
                ...
                "!pip install -q -e .\n",
                "!pip install -q -r requirements.txt\n",
                "# Install all animate deps explicitly (requirements_animate.txt fails on SAM-2)\n",
                "!pip install -q decord peft onnxruntime-gpu pandas matplotlib loguru sentencepiece\n",
                "!pip install -q ftfy regex 'huggingface_hub[cli]'\n",
                "# SAM-2 (Facebook's Segment Anything) - clone + install to avoid name conflict\n",
                "%cd /content\n",
